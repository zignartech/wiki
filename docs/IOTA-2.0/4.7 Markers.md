...
### 4.7.5.2 Creation of marker-sequences
...
### 4.7.6.1 Update of already booked messages on double spends
...
## 4.7.7 Marker Application Description
...
**Image 4.7.1:** Markers and marker-sequences in the Tangle.

### 4.7.7.1 Example Implementation
...
### 4.7.7.2 Approval weight approximation
