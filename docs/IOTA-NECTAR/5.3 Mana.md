...
* [Section 6.5 - Distributed Random Number Generator](./6.5%20dRNG.md): The dRNG committee members must be composed by high consensus Mana nodes.
...
## Detailed Design - Consensus Mana
...
## Consensus Mana update procedure
...
**Table 4.3.1 List of Parameters**
