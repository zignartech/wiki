...
The table describing the entirety of a <i>Transaction</i>'s serialized form is presented in the [Section 2.3 Standard Payloads Layout](./2.3%20Standard%20Payloads%20Layout.md#transaction-payload).

See [Message Layout](./2.2%20Message%20Layout.md)
